...
- **Sincronização Nativa & Fingerprint**:
  - Sincronizados os metadados e fingerprints nativos dos projetos Android (`versionCode: 59`, `versionName: 2.0.22`) e iOS (`buildNumber: 59`, `version: 2.0.22`) via prebuild limpo.
