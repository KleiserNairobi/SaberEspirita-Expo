...
interface CommunityLevelInfoBottomSheetProps {
  currentLevelId?: string;
  onDismiss?: () => void;
}

export const CommunityLevelInfoBottomSheet = forwardRef<
  BottomSheetModal,
  CommunityLevelInfoBottomSheetProps
>(({ currentLevelId = "sementeiro", onDismiss }, ref) => {
  ...
  const config: BottomSheetMessageConfig = {
    ...
    message: "Seu nível é um reconhecimento simbólico da sua jornada: estudo + participação no fórum.",
    primaryButton: {
      label: "Entendi",
      onPress: () => {
...
CommunityLevelInfoBottomSheet.displayName = "CommunityLevelInfoBottomSheet";
