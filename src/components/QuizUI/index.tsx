...
export function QuizUI({
  ...
  const [isBottomSheetMounted, setIsBottomSheetMounted] = useState(false); // ← NOVO
  ...
  function handleSkipConfirm() {
    setNext(true);
    setIsBottomSheetMounted(true); // ← NOVO: monta antes de abrir
  ...
  function handleNextQuestion() {
    ...
    setStop(false);
    setNext(false);
    setIsBottomSheetMounted(false); // ← NOVO: desmonta ao fechar
...
//   showStopButton?: boolean;
//   isSubmitting?: boolean;
//   /** Quando true, usa originCategory/originSubcategory de cada questão como título/barTitle dinâmicos */
//   dynamicTitles?: boolean;
//   onFinish: (answers: IQuizAnswer[]) => void;
//   onStop: () => void;
// }
...
//   if (!currentQuestion) {
//     return null; // Caso questions mude inesperadamente e o index estoure
//   }
