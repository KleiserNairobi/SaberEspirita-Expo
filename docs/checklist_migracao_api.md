...
| **2026-08-20** | Antigravity AI | Telas, Hooks e Stores | Substituição completa de todos os serviços legados do Firebase em telas, hooks, stores e Chat IA. Invocação direta da API REST Spring Boot em 100% das telas (`src/pages/`) e validação TypeScript limpa (`0 erros`). |
